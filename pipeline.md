...
A step-by-step walkthrough of the *Mnemiopsis* cathepsin analysis notebook. Run all cells **in order** — each stage depends on variables set in the previous step.
